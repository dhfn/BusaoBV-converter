...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        * */
        ...
        /*
        * Transforma o arquivo em um documento, compat�vel com a bibiblioteca.
        * */
    ...
    public List<Linha> getLinhasFromWorkbook(HSSFWorkbook workbook){
        ...
        * */
        for(int i = 0; i < qtdSheets-1; i++){
            // Um objeto linha � instanceado a cada itera��o para que seja adicionado a lista de linhas
            Linha linha = new Linha();

            // Instancia a planilha que ser� lida na itera��o.
            ...
            /*
            * Preenche os campos de nome e n�mero do objeto linha.
            * */
            ...
            /*
            * Percorre todas as linhas a partir da primeira linha com informa��es que precisam ser lidas no
            * documento.
            * */
            for (int j = 4; j < qtdRows; j++){
                ...
                /*
                * A partir daqui, o programa l� linha por linha e adciona cada informa��o em suas listas de acordo com
                * o n�mero de sua coluna.
                * As colunas no excel s�o representadas por letras, mas no programa, por n�mero de 0 a 'n'.
                * Por exemplo, a coluna A, primeira coluna, na qual cont�m as informa��es do Horario de saida do bairro nos dias uteis
                * � representado aqui pelo numero 0 (zero).
                * */

                // Hor�rios de sa�da do BAIRRO nos DIAS �TEIS.
                try {
                ...
                // Hor�rios de sa�da do CENTRO nos DIAS �TEIS.
                try {
                ...
                // Hor�rios de sa�da do BAIRRO nos SABADOS.
                try {
                ...
                // Hor�rios de sa�da do CENTRO nos SABADOS.
                try {
                ...
                // Hor�rios de sa�da do BAIRRO nos DOMINGOS.
                try {
            ...
            /*
            * Aqui o objeto totalmente populado com as informa��es lidas da planilha � adicionado a lista.
            **/
            linhas.add(linha);
        }
        ...
        for (int i = 0; i < qtdRows; i++) {
            ...
            for (String rua : ruas){
                if (rua.contains(cell.getStringCellValue())){
                    verifica = false;
                    System.out.println("N�o add: "+rua+" - "+cell.getStringCellValue());
                }
            }
